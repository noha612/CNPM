...
INSERT INTO `tblgiangvien` VALUES (1,6,'CNTT','CNTT','Tiến Sĩ','x'),(2,7,'CNTT','CNTT','Tiến Sĩ','x'),(3,8,'CNTT','ATTT','PGS. Tiến Sĩ','x'),(4,9,'CNTT','CNTT','Tiến Sĩ','x'),(6,119,'CB','CB','Tiến Sĩ','x'),(7,120,'CNTT','ATTT','Thạc Sĩ','x'),(8,121,'CB','CB','PGS. Tiến Sĩ','x'),(9,122,'CNTT','CNTT','Tiến Sĩ','x'),(10,123,'ĐTVT','VT','Thạc Sĩ','x'),(11,124,'CNTT','ATTT','Tiến Sĩ','x'),(12,125,'CB','CB','Tiến Sĩ','x'),(13,126,'ĐPT','TTĐPT','Tiến Sĩ','x'),(14,127,'CNTT','CNTT','Tiến Sĩ','x'),(15,128,'KT','KT','Tiến Sĩ','x'),(16,129,'CNTT','CNTT','Thạc Sĩ','x'),(17,130,'CNTT','ATTT','PGS. Tiến Sĩ','x'),(18,131,'CNTT','CNTT','Tiến Sĩ','x'),(19,132,'ĐTVT','ĐT','Thạc Sĩ','x'),(20,133,'CNTT','CNTT','Tiến Sĩ','x'),(21,134,'CNTT','ATTT','Tiến Sĩ','x');
...
INSERT INTO `tblmonhoc` VALUES (1,'INT1340','Nhập môn Công nghệ phần mềm',3,45,0,0,0.1,0.1,0,0.2,0.6,NULL,'x','CNTT'),(4,'INT1362','Xử lý ảnh',2,45,0,0,0.1,0.1,0.1,0,0.7,NULL,'x','CNTT'),(7,'TST1111','13 Tín Chỉ',13,100,0,0,0,0,0,0,1,NULL,'x','CB'),(9,'BAS1141','Tiếng Anh A11',4,45,0,0,0,0,0,0,1,NULL,'x','CB'),(10,'BAS1142','Tiếng Anh A12',4,45,0,0,0,0,0,0,1,NULL,'x','CB'),(11,'BAS1143','Tiếng Anh A21',4,45,0,0,0,0,0,0,1,NULL,'x','CB'),(12,'BAS1144','Tiếng Anh A22',4,45,0,0,0,0,0,0,1,NULL,'x','CB'),(14,'INT1341','Nhập môn trí tuệ nhân tạo',3,45,0,0,0.1,0.1,0,0.1,0.7,NULL,'x','CNTT'),(15,'INT1336','Mạng máy tính',3,40,0,5,0.1,0.1,0.2,0,0.6,NULL,'x','CNTT'),(16,'INT1328','Kỹ thuật đồ họa',3,45,0,0,0.1,0.1,0,0.1,0.7,NULL,'x','CNTT'),(17,'INT1303','An toàn bảo mật hệ thống thông tin',3,40,0,5,0.1,0.1,0,0.2,0.6,NULL,'x','CNTT'),(18,'INT1332','Lập trình hướng đối tượng',3,45,0,8,0.1,0.2,0.2,0,0.5,NULL,'x','CNTT'),(19,'INT1306','Cấu trúc dữ liệu và giải thuật',3,45,0,0,0.1,0.2,0.2,0,0.5,NULL,'x','CNTT'),(20,'INT1358','Toán rời rạc 1',3,45,0,0,0.1,0.1,0,0.1,0.7,NULL,'x','CNTT'),(21,'INT1359','Toán rời rạc 2',3,45,0,0,0.1,0.1,0,0.1,0.7,NULL,'x','CNTT'),(22,'INT1313','Cơ sở dữ liệu',3,40,0,5,0.1,0.1,0,0.2,0.6,NULL,'x','CNTT'),(23,'INT1319','Hệ điều hành',3,40,0,5,0.1,0.1,0.1,0,0.7,NULL,'x','CNTT'),(24,'INT1330','Kĩ thuật vi xử lý',3,45,0,0,0.1,0.1,0,0.2,0.6,NULL,'x','CNTT'),(25,'INT1154','Tin học cơ sở 1',3,35,0,10,0.1,0.1,0.2,0,0.6,NULL,'x','CNTT'),(26,'INT1155','Tin học cơ sở 2',3,35,0,0,0.1,0.1,0.2,0,0.6,NULL,'x','CNTT'),(27,'INT1339','Ngôn ngữ lập trình C++',3,35,0,0,0.1,0.1,0.2,0,0.6,NULL,'x','CNTT'),(28,'ELE1330','Xử lý tín hiệu số',3,45,0,0,0.1,0.1,0,0.2,0.6,NULL,'x','CNTT'),(29,'ELE1319','Lý thuyết thông tin',3,45,0,0,0.1,0.1,0,0.2,0.6,NULL,'x','CNTT'),(30,'BAS1324','Vật lý 1 và thí nghiệm',4,40,0,5,0.1,0.1,0.2,0,0.6,NULL,'x','CNTT'),(31,'BAS1327','Vật lý 3 và thí nghiệm',4,40,0,5,0.1,0.1,0.2,0,0.6,NULL,'x','CNTT');
...
INSERT INTO `tblphonghoc` VALUES (1,'101 A2','Mặt Trước',59,'Máy chiếu + Điều hòa',1),(2,'102 A2','Mặt Sau',59,'Máy chiếu + Điều hòa + TV',1),(3,'201 A2','Mặt Trước',59,'Máy chiếu + Điều hòa',1),(4,'203 A2','Mặt Sau',59,'Máy chiếu + Điều hòa',1),(5,'303 A3','Mặt Trước',59,'Máy chiếu + Điều hòa + TV',1),(6,'302 A3','Mặt Sau',59,'Máy chiếu + Điều hòa',1);
...
-- Dump completed on 2019-05-07 11:28:50
